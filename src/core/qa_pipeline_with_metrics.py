...
from src.evaluation.metrics.retrieval import calculate_before_after_reranking_metrics, format_metrics_for_display
...
def answer_question_with_retrieval_metrics(
    ...
    *,
    ...
    from src.core.qa_pipeline import refine_and_prepare_query
...
def print_batch_metrics_summary(all_metrics: List[Dict]):
    ...
    # Calcular promedios
    from src.evaluation.metrics.retrieval import calculate_aggregated_metrics
