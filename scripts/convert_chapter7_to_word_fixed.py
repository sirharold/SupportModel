...
Versión mejorada que maneja correctamente bloques de código Python
"""
...
def setup_document_styles(doc):
    ...
    # Agregar fondo gris claro al código
    try:
        pPr = code_style._element.get_or_add_pPr()
        shading = OxmlElement('w:shd')
        shading.set(qn('w:val'), 'clear')
        shading.set(qn('w:color'), 'auto')
        shading.set(qn('w:fill'), 'F5F5F5')  # Gris claro
        pPr.append(shading)
    except:
        pass  # Si falla el sombreado, continuar sin él
...
def add_code_block(doc, code_lines):
    """Agregar bloque de código con formato especial"""
...
def convert_chapter7_to_word():
    ...
    output_file = '/Users/haroldgomez/Documents/ProyectoTituloMAgister/SupportModel/Docs/Finales/words/capitulo_7_completo_actualizado_fixed.docx'
    ...
    for line in lines:
        ...
        if line_stripped.startswith('# '):
            ...
            if '7.2.1' in title:
                ...
                section_counters['section'] = 4
                section_counters['subsection'] = 0
            elif '7.5' in title:
                section_counters['section'] = 5
                section_counters['subsection'] = 0
            elif '7.6' in title:
                section_counters['section'] = 6
                section_counters['subsection'] = 0
            elif '7.7' in title:
                section_counters['section'] = 7
                section_counters['subsection'] = 0
            elif '7.8' in title:
                section_counters['section'] = 8
                section_counters['subsection'] = 0
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("  • Código: Formato Consolas con fondo gris")
